...
// This new endpoint provides aggregated data for the admin dashboard and analytics.
...
try {
    ...
    $stmt_views_clicks = $pdo->query("
        SELECT 
            (SELECT COUNT(*) FROM House_Analytics WHERE event_type = 'view') as total_views,
            (SELECT COUNT(*) FROM House_Analytics WHERE event_type = 'click') as total_clicks
    ");
